...
from wavelet_utils_vSpeed import make_and_save_FilterLibrary_vS, makeFilterParamDict_vS, loadFilterParamDict_vS, compute_and_save_dwt_vS
...
screen_t = 3 # time dimension of the screen analysis in frames
...
print(f"Drift speeds (degrees/frame): {drifts}")
...
#lib_path, sidecar_path = make_and_save_FilterLibrary_vS(temppath, params)
...
#xs, ys, angles, sizes, freqs, drifts, phases, visual_coverage, full_screen_coverage, screen_x, screen_y = loadFilterParamDict_vS(sidecar_path)
...
dwt_path=compute_and_save_dwt_vS(downsampled_video_path, params)
