...
The calculations are based on the [skriabineSop/waven](https://github.com/skriabineSop/waven) Python package, see related publication: 
...
## Installation
The package can be installed from PyPI with `pip install waven2`.
